        ...
        <div className="border-b mb-6">
          <div className="flex space-x-8">
            <button
              ...
              className={`py-2 px-1 -mb-px font-medium text-sm ${activeTab === "overview" ? "border-b-2 border-black text-black" : "text-gray-500 hover:text-gray-700"
                }`}
            >
              Overview
            </button>
            <button
              ...
              className={`py-2 px-1 -mb-px font-medium text-sm ${activeTab === "documents" ? "border-b-2 border-black text-black" : "text-gray-500 hover:text-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`py-2 px-1 -mb-px font-medium text-sm ${activeTab === "images" ? "border-b-2 border-black text-black" : "text-gray-500 hover:text-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`py-2 px-1 -mb-px font-medium text-sm ${activeTab === "videos" ? "border-b-2 border-black text-black" : "text-gray-500 hover:text-gray-700"
                }`}
            >
            ...
            <div className="card p-4 md:col-span-2">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <div className="flex flex-col items-center">
                    <div
                      className={`rounded-full w-6 h-6 flex items-center justify-center text-xs ${claim.status === "submitted" ? "bg-gray-200 text-gray-500" : "bg-yellow-500 text-white"
                        }`}
                    >
                      2
                    </div>
                ...
                <div className="flex gap-3">
                  <div className="flex flex-col items-center">
                    <div
                      className={`rounded-full w-6 h-6 flex items-center justify-center text-xs ${claim.status === "submitted" || claim.status === "analyzed"
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center mt-2">
                        <span
                          className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold ${doc.verified ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
                            }`}
                        >
                  ...
                  <div key={video.id} className="border rounded-md overflow-hidden">
                    ...
                    <div className="p-3">
                      <div className="flex justify-between items-center mb-2">
                        <p className="font-medium">Video Evidence</p>
                        <span
                          className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold ${video.model_status === "done"
